...
Patrick:
 - Continued to work on the dataloader, in particular fixing a problem in which images with different rotations were being compared
 - Worked on code for data visualizations and graphs
 - Helped tune the loss function
 - Worked with model architecture
